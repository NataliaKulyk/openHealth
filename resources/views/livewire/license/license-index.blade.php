    ...
    <div class="max-w-7xl mx-auto px-4 py-6">
        ...
        <table class="table-input w-inherit">
            ...
            <tr>
                ...
                <th scope="col" class="th-input">{{__('forms.active_from_date')}}</th>
                <th scope="col" class="th-input">{{__('forms.expiry_date')}}</th>
                <th scope="col" class="th-input">{{__('forms.activity')}}</th>
                <th scope="col" class="th-input">{{__('forms.но')}}</th>

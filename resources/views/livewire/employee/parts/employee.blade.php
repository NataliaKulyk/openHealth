    ...
    <form class="form">
        ...
        >
            <div class="form-group group relative z-0">
                <input wire:model="form.party.taxId" required id="taxId" type="text" name="taxId" maxlength="10" placeholder=" " wire:model="form.party.taxId" aria-describedby="{{ $errors->has('form.party.taxId') ? 'partyTaxIdErrorHelp' : '' }}" class="input {{ $errors->has('form.party.taxId') ? 'input-error border-red-500 focus:border-red-500' : ''}} peer text-gray-500"
                />
        ...
        <div class="form-row-3">
            <div class="form-group">
                <select x-model = "phone.type" name="phoneType" id="phoneType-@{{ index }}" class="peer input appearance-none bg-white text-gray-500 dark:bg-gray-800 dark:text-gray-400" required>
                ...
                <label for="phoneType" class="label">{{ __('forms.phone_type') }}</label>
                <p class="text-error"
        ...
        <div class="form-row-3">
            <div class="form-group">
                <input wire:model="form.party.email" type="text" name="email" id="email" class="peer input text-gray-500" placeholder=" " required />

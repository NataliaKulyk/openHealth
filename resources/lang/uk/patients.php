...
return [
    ...
    */
    ...
    'please_clarify_phone_number' => 'Уточніть, будь ласка, про наявність доступу до даного номеру телефона пацієнта',
    ...
    'confirm' => 'Підтвердити',
    'if_patient_not_phone_authentication' => 'У разі відсутності доступу до номеру телефона +38095123ххххх пацієнту необхідно звернутись до НСЗУ для скидання його методу автентифікації.',

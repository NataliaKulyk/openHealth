...
return [
    ...
    'contract' => [
        ...
        'show' => 'Показувати',
        'showContract' => 'Обрати догорів',
        'new_contract' => 'Новий договір',
        'startDateContract' => 'Дата початку дії',
        'endDateContract' => 'Дата закінчення дії',
        'action' => 'Дія',
        ...
        'numberOfPeople' => 'Кількість населення, що обслуговується',
        'chooseLocation' => 'Обрати місце надання послуг',
    ],
];
